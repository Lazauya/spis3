...
//this is my own definition of getbytype, probably more accurate to how it's done internally. the skse guys forgot about the gettype vfunc
BSExtraData* BaseExtraList::GetByType(UInt32 type) const {
	if (!HasType(type)) return NULL;
